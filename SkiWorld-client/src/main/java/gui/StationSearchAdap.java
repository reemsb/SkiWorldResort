...
public class StationSearchAdap extends AbstractTableModel{
	String[] headers={"station nbr","Label","lattitude","longitude","Description"};
    List<SkiStation> stations = new ArrayList<>();
    
    public StationSearchAdap() {
    	 
    //	stations = StationServiceDelegate.doFindStationByName(label);
